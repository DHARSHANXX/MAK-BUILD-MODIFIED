...
# 1. 100% Before state (pos = 100%)
$mod100 = $cleanHtml -replace 'id="ba-slider-box" class="ba-container', 'id="ba-slider-box" style="--ba-pos: 100%;" class="ba-container'
...
# 2. 100% After state (pos = 0%)
$mod0 = $cleanHtml -replace 'id="ba-slider-box" class="ba-container', 'id="ba-slider-box" style="--ba-pos: 0%;" class="ba-container'
...
Write-Output "Real 100% states captured."
